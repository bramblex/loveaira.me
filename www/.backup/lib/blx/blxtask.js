;(function(){
  ...
  //==================================================
  var Task = BlxClass.extend('BlxBaseTask', EventEmitter, function(func){
    this.func = func || undefined;
    this.status = STOP;
  });

  BlxBaseTask.prototype.start = function start(data){
  ...
  BlxBaseTask.prototype.fork = function fork(){
    return new this.constructor(this.func);
  };
